 ...
 * Use the [ArchivedShoppingListFragment.newInstance] factory method to
...
class ArchivedShoppingListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ArchivedShoppingListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ArchivedShoppingListFragment().apply {
